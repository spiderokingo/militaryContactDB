...
$outp ='{"Status":"success","PersonalReport":['.$outp.']}';
}
...
if($_POST["Mode"] == "UPDATE"){
	...
	$sql .= "GrandTotal='".$_POST["GrandTotal"]."'";
...
if($_POST["Mode"] == "INSERT"){
	...
	$sql .= "(Date, Company, GrandTotal, A, B, C, D, E, F, G, H, I, J, UserReport, DateTime)";
	$sql .= " VALUES";
	$sql .= " ('".$today."','".$_POST["Company"]."','".$_POST["GrandTotal"]."','".$_POST["DistributionList"][0]["Value"]."','".$_POST["DistributionList"][1]["Value"]."','".$_POST["DistributionList"][2]["Value"]."','".$_POST["DistributionList"][3]["Value"]."','".$_POST["DistributionList"][4]["Value"]."','".$_POST["DistributionList"][5]["Value"]."','".$_POST["DistributionList"][6]["Value"]."','".$_POST["DistributionList"][7]["Value"]."','".$_POST["DistributionList"][8]["Value"]."','".$_POST["DistributionList"][9]["Value"]."','".$_POST["UserReport"]."','".$time."')";
